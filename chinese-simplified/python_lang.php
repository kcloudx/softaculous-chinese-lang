...
$l['python_message'] = 'Python 未安装。要安装它，请点击<a href="'.$globals['index'].'act=apps&app=29">这里</a>';
$l['python_title'] = '你的服务器上没有安装 Python';
...
$l['not_python_script'] = '此脚本不在 Python 中';
...
$l['in_directory'] = '在目录中';
$l['in_directory_exp'] = '该目录与您的域相关，<b>不应该存在</b>。例如要安装在 http://mydomain/dir/ 只需输入 <b>dir</b>.';
...
$l['no_python_support'] = '此面板不支持 Python 脚本安装';
