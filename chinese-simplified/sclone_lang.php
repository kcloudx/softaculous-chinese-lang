...
$l['ins_recursive'] = '您不能将安装克隆到原始安装的子目录中';
$l['no_clone_support'] = '此脚本不支持克隆';
...
$l['prog_cloning'] = '克隆'; // 不要删除尾随空格
$l['prog_cloning_complete'] = '克隆完成。';
$l['checking_data'] = '检查提交的数据';
$l['unzipping_files'] = '复制文件和文件夹';
$l['unzipping_datadir'] = '解压数据文件';
$l['prop_db'] = '传播数据库';
$l['finishing_process'] = '完成克隆';
...
$l['no_mysql_install'] = 'MySQL 未安装编译。要安装它，请点击<a href="'.$globals['index'].'act=apps&app=16">此处</a>';
