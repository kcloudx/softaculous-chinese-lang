...
$l['no_backup_loc_id'] = '备份位置 ID 未发布';
$l['invalid_backup_loc_id'] = '备份位置 ID 无效';
$l['rbackup_protocol_disabled'] = '<b>&soft-1;</b> 上的备份被管理员禁用';

//主题字符串
$l['<title>'] = '编辑备份位置';
$l['edit_backup'] = '编辑备份位置';
...
$l['edit_backup_loc'] = '保存更改';
$l['backup_loc_saved'] = '备份位置详细信息保存成功';
$l['ftp'] = 'FTP';
$l['return_settings'] = '返回设置';

$l['dropbox'] = 'Dropbox';
$l['dropbox_authorization'] = '授权';
$l['dropbox_authorize'] = '重新授权';
$l['dropbox_authorization_exp'] = '点击重新授权'.APP.' APP访问权限以在您的 Dropbox 帐户中创建备份。点击<b>重新授权</b>按钮并按照步骤操作。记下生成的代码并在下面的<b>Auth Code</b> 文本框中输入相同的代码';
$l['dropbox_code'] = '验证码';
$l['dropbox_code_exp'] = '输入通过上面的<b>重新授权</b>按钮允许访问后生成的代码';
...
$l['aws_backup_loc_exp'] = '备份目录，例如/backups 或者您可以留空以允许'.APP.'到管理备份目录';
