...
$l['java_message'] = 'Java 未安装。要安装它，请点击<a href="'.$globals['index'].'act=apps&app=37">此处</a>';
$l['java_title'] = '你的服务器上没有安装Java';
...
$l['no_java_support'] = '此面板不支持 Java 脚本安装';
