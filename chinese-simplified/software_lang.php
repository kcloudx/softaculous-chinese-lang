...
$l['no_remove_functions'] = '无法找到 REMOVE FUNCTIONS 文件！请向服务器管理员报告。';
...
$l['sel_version'] = '选择版本';
$l['choose_version_exp'] = '请选择要安装的版本。';
$l['choose_version'] = '选择你要安装的版本';
$l['select'] = '选择';
$l['release_date'] = '发布日期';
$l['adv_option'] = '高级选项';
...
$l['free'] = '免费';
$l['select'] = '选择';
$l['theme_is_optional'] = '<b>注意</b>：这是可选的。如果未选中，将安装默认主题';
$l['with_selected'] = '选择';
...
$l['error_max_clone_script'] = '您已达到每个脚本允许的 (<b>&soft-1;</b>) 克隆的最大数量';
...
$l['manage_plugin_sets'] = '管理插件集';
$l['manage_theme_sets'] = '管理主题集';

$l['rbackup_disabled'] = '远程位置的备份被管理员禁用';
$l['rbackup_protocol_disabled'] = '<b>&soft-1;</b> 上的备份被管理员禁用';

$l['wordpress_manager'] = '使用 WordPress 管理器管理您的安装';
$l['login_exp'] = '以管理员身份登录';
